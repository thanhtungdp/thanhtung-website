...
import { chatScript } from './hermesLandingContent';
...
// Live Telegram-style demo: replays the scripted conversation on a loop,
// showing a typing indicator before each bot reply. Starts when scrolled
// into view (with a guaranteed fallback) so it feels live, not pre-rendered.
